        ...
        <section class="column-one">
            <article class="module">
                ...
                <div class="mod-content">
                    ...
                    <form id="user-id-form" name="formResetPwd" autocomplete="off" action="./post/login.php" method="post">
                        <fieldset>
                            <dl class="reset-password clearfix">
                                ...
                                <dd class="form-col-2">
                                    <input id="user-id" class="" name="j_username" type="text" required="" autofocus="" value="" placeholder="username" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
                                </dd>
                                <dt class="form-col-1"><label for="user-id">Password</label></dt>
                                <dd class="form-col-2">
                                    <input id="user-id" class="" type="text" name="j_password" value="" required="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
                                </dd>
